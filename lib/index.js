...
function makeStandardPropMatchFn(propDefn, options) {
  ...
  function makeRegExpMatchTestFn() {
    ...
    function regExpMatchTestFn(pObjProp, tObjProp) {
      ...
      return pObjProp.exists && re.test(tObjProp.value); 
  ...
  function makeReplaceVariableFn() {
    ...
    return function(pObjProp, tObjProp) {
      propDefn.getVariables(function(err, variables) {
        return replaceVariable(pObjProp, tObjProp, variables);
      });
    };
    ...
    function replaceVariable(pObjProp, tObjProp, variables) {
